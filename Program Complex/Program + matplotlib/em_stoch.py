...
def multi_start_EM(X: np.ndarray,
    ...
    for i in range(num_of_starts):
        ...
        est_theta, est_P, est_lhd, thetas, Ps = EM(theta, P, X, Q, max_iter, rtol)
        all_thetas[i] = thetas
        all_Ps[i] = Ps
        if est_lhd > best_lhd:
    ...
    return best_theta, best_P, best_lhd, all_thetas, all_Ps
