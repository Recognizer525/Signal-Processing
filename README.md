...
* Директория **New Program Complex** включает в себя новые версии программных реализаций. Общие функции объединены в такие модули как **sensors.py** и **optim_doa.py**. В директории **График при фиксированном theta** проиллюстрирована монотонность правдоподобия, а также показан график зависимости правдоподобия от угла.
