...
\begin{equation}
\left\{ \begin{aligned} 
\mu_{S_t|\mathcal{I}_t, X_{t, m_t}} &= \mathbf{\Gamma}\text{A}^* \widetilde{\Sigma}_{X_t}^{-1}\Expect[X_t|\mathcal{I}_t], \\
\Sigma_{S_t|\mathcal{I}_t, X_{t, m_t}} &= \mathbf{\Gamma} - \mathbf{\Gamma}\text{A}^*  \widetilde{\Sigma}_{X_t}^{-1}\text{A}\mathbf{\Gamma},
\end{aligned} \right.
\end{equation}
