...
\begin{enumerate}
\item
Dempster A. P., Laird N. M., Rubin D. B. Maximum likelihood from incomplete data via the EM algorithm // J. R. Stat. Soc., Ser. B (Methodol.). -- 1977. -- Vol. 39. -- P. 1–38.
\item
Wu C. F. J. On the convergence properties of the EM algorithm // The Annals of Statistics. -- 1983. -- Vol. 11, № 1. -- P. 95–103.
\end{enumerate}
\end{document}
