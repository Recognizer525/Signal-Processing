...
\begin{equation*}
\begin{gathered}
h^* = \frac{1}{\text{L}} \Tr (\Expect_{q(\Xi)}[XX^*]) - 2 \Re \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[X S^*]) + \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[SS^*] \text{A}^*(\theta)).
\end{gathered}
\end{equation*}
...
\begin{equation*}
\begin{gathered}
h^{(\tau)} = \max \bigg(\frac{1}{\text{L}} \Tr (\Expect_{q(\Xi)}[XX^*]) - 2 \Re \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[X S^*]) + \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[SS^*] \text{A}^*(\theta)),\varepsilon \bigg).
\end{gathered}
\end{equation*}
\end{document}
