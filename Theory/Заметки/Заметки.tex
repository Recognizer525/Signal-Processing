...
- \text{T} \Big[\log|\mathbf{\Lambda}| +\Tr \big( \mathbf{\Lambda}^{-1} \Expect_{q(\Xi)}[XX^*] \big) - 2 \Re \Tr\big(\mathbf{\Lambda}^{-1} \text{A}(\theta) \Expect_{q(\Xi)}[X S^*]\big) \\
...
\begin{equation*}
\begin{gathered}
 \Tr (\Expect_{q(\Xi)}[XX^*]) - 2 \Re \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[X S^*]) + \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[SS^*] \text{A}^*(\theta)).
\end{gathered}
\end{equation*}
Получаем функцию
\begin{equation*}
...
\begin{equation*}
\begin{gathered}
h^* = \frac{1}{\text{L}} \Big( \Tr (\Expect_{q(\Xi)}[XX^*]) - 2 \Re \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[X S^*]) + \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[SS^*] \text{A}^*(\theta)) \Big).
\end{gathered}
\end{equation*}
...
\begin{equation*}
\begin{gathered}
h^{(\tau)} = \max \bigg(\frac{1}{\text{L}} \Big( \Tr (\Expect_{q(\Xi)}[XX^*]) - 2 \Re \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[X S^*]) + \Tr(\text{A}(\theta) \Expect_{q(\Xi)}[SS^*] \text{A}^*(\theta)) \Big),\varepsilon \bigg).
\end{gathered}
\end{equation*}
\end{document}
