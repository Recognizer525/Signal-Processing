...
\end{equation*}
и $X_t \in \Complex^{\text{L}}, S_t \in \Complex^{\text{K}}, N_t \in \Complex^{\text{L}}$ -- векторы-столбцы, соответствующие наблюдениям, источникам и шумам в момент времени  $t = 1, \ldots, \text{T}$, $\text{A}(\theta)$ -- матрица векторов направленности для равномерной линейной антенной решетки:
\begin{equation*}
